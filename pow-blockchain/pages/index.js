        ...
        <div className={styles.container}>
...

          {
            ...
            <p className={styles.description}>
              PoW-BlockChain.js est une démo d'application web faisant tourner une blockchain à validation par Proof of
              Work en javascripts
            </p>
            ...
            <p className={styles.description}>
            Créez vous un wallet et intéragissez avec la blockchaine en creant des transactions et en minant
            </p>
               <Card fluid  style={{padding:"3rem"}}>
                    <AddTransaction
                      blockchain={blockchain}
