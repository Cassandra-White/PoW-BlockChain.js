        ...
        <Grid>
          <Grid.Row>
            <Grid.Column width={8}>
              ...
              <Message
                positive
                hidden={this.props.messageDifficulty == ""}
                header="Changement : Difficulté de minage"
                content={this.props.messageDifficulty}
              />
              <Message
                negative
                hidden={this.props.messageErrorDifficulty == ""}
            ...
            <Grid.Column width={8}>
              ...
              <Message
                positive
                hidden={this.props.messageMiningReward == ""}
              ...
              <Message
                negative
                hidden={this.props.messageErrorMiningReward == ""}
